...
(function(angular) {
      ...
      function($injector) {
        ...
        var sendMessage = function(data) {
          ...
          if (deleteHeaders) {
            ...
            var headersToDelete = Object.keys($http.defaults.headers.common).concat(
              Object.keys($http.defaults.headers.post)
            );
  ...
  angular.module('logglyLogger', ['logglyLogger.logger']).config([
    '$provide',
    function($provide) {
